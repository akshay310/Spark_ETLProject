...
def validate_data_quality(spark_df, required_columns, allowed_values, required_datatypes, unique_values):
    """
    Validates data quality using Great Expectations, ensuring data consistency, uniqueness, and type correctness.
    ...
    try:
        ...
        for date_col in date_columns:
            expectations.append(df_ge.expect_column_values_to_match_regex(date_col, r"\w{3} \d{1,2} \d{4}"))
