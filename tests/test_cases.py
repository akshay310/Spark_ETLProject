...
#                             },
#                         )
#    good_data, bad_data = quality_checks(df,{"data_quality":[
#     {"check": "column_values_to_be_between", "parameters": {"column": "trip_distance", "min_value": 0.01, "max_value": 500}},
#     {"check": "column_values_to_be_in_set", "parameters": {"column": "rate_code", "value_set": [1, 2, 3, 4, 5, 6]}}
#     ]})
...
#     mock_df = mocker.Mock()
#     db_config = {"database": {"db_name": "test_db", "db_table": "test_table"}}
...
def test_quality_checks(spark, sample_parquet):
    ...
    good_data, bad_data = quality_checks(
        df,
        {
            "data_quality": [
                {
                    "check": "column_values_to_be_between",
                    "parameters": {"column": "trip_distance", "min_value": 0.01, "max_value": 500}
                },
                {
                    "check": "column_values_to_be_in_set",
                    "parameters": {"column": "rate_code", "value_set": [1, 2, 3, 4, 5, 6]}
                }
            ]
        }
    )
